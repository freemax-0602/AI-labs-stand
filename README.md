...
Практическая документация по подготовке Windows- и macOS-окружения для лабораторных работ: C/C++-разработка в Linux, Docker Compose, MySQL и PostgreSQL.

> Инструкции проверены по официальной документации, актуальной на 19 сентября 2026 года. Перед установкой новых версий ПО сверяйтесь со ссылками в конце каждой главы.
...
1. Выберите ветку для своей ОС: Windows или macOS.
